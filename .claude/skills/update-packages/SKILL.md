...
```sh
for p in cli demos docs minimal mochi mochi-rsvelte mochi-svelte-shaker minimal-rsvelte msgpackr-extract-stub queue shared site support video-animations; do
