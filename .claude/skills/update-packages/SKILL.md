...
| Pin                                                                         | Why                                                                                                                                                                                                                                                                                           |
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `svelte-check` (all workspaces)                                             | Patched at runtime by `mochi-framework prepare` (`packages/mochi/src/cli/svelteCheckPatch.ts`), which anchors on svelte2tsx internals rather than a version. A bump won't orphan the patch, but re-run `bun run typecheck` and confirm `prepare` still reports a patch rather than a warning. |
