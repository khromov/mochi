...
| Pin                                                                         | Why                                                                                                                                                                                                                                                                                              |
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `svelte-shaker` (`packages/mochi`)                                          | We consume its internal `svelte-shaker/node` subpath of a pre-1.0 package; releases have shipped shake-aborting regressions that our fallback swallows silently. Exact pin so no movement reaches published-package consumers. See the comment in `packages/mochi/src/compiler/svelteShaker.ts`. |
