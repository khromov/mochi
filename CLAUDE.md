...
- To generate unique DOM IDs within an island (e.g. for `<label for>`), use Svelte 5's native `const uid = $props.id();` which provides a stable ID across server and client.
