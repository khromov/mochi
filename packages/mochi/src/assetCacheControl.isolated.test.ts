...
// `Mochi.serve()` is called twice in one process. Fixture is SSR-only (no
// hydration) — pulling in the `mochi-framework` virtual module via a
// hydratable child trips the Bun bundler EISDIR bug noted in CLAUDE.md.
