...
// Server-island props swapped from devalue to msgpackr; these assert the codec keeps devalue's documented type
// support. The one known divergence is -0 (msgpackr restores +0), covered explicitly.
