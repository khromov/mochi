// Ported verbatim from the vendored devalue fork's own test suite (upstream src/utils.test.js); only the imports
...
import { valid_array_indices } from './src/utils.js';
