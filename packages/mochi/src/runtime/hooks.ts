 ...
 *                   the `/_mochi/client/stats` dev endpoint, an extracted font /
 *                   imported-CSS asset, or a `/_mochi/island/*` server-island fragment
 ...
 */
export type MochiEventKind = 'page' | 'api' | 'asset' | 'public' | 'file' | 'fallback' | 'error';
