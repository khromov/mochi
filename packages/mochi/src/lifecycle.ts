 ...
 * sequence — the jobs handle above all — must tell "you're too early" apart from "you got the name wrong", and inferring
 ...
 */
export type MochiStartupMilestone = 'mochi:init' | 'mochi:listening' | 'mochi:jobsMounted' | 'mochi:ready';
