...
<div class="modes">
  <div class="mode">
    <button disabled={rendered.reloading} onclick={() => reloadDeferredIsland('flaky')}>Reload 4 — make the render throw</button>
    <p class="note">
  ...
  <div class="mode">
    <button disabled={offline.reloading} onclick={reloadOffline}>Reload 5 — make the fetch fail</button>
    <p class="note">
