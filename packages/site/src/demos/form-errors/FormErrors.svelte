...
<DemoPage
  title="Form Errors"
  description={`Both standard HTML forms and progressively enhanced forms can handle errors gracefully. With {@attach enhance(...)}, the error message is shown inline. Without it, Mochi renders the server error page.`}
  {sources}
>
  <p>
