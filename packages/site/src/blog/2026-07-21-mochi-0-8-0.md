...
Use [`Mochi.queue()`](/docs/jobs/) to easily defer work to the background and take it off the request path — for example sending email, encoding media or calling a slow API.
