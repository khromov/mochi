...
The hosted `SKILL.md` is unsigned, and it is instructions your coding agent will follow. When the file already exists and the fetched copy differs, the CLI prints a unified diff and asks before writing:
...
```
[mochi] Unsigned update fetched from https://mochi.fast/SKILL.md:
