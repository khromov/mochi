...
title: 'Serve options'
slug: serve-options
ogTitle: 'Every Mochi.serve() option'
...
- `protection` — Cloudflare-style browser verification: unverified clients get an interstitial that auto-solves the captcha proof-of-work and redeems it for a signed clearance cookie, bound by default to the client's network prefix and key headers. Default: disabled. See [Protection Mode](/docs/protection/).
