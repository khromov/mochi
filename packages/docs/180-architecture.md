...
- `packages/mochi/src/serverIslandCrypto.ts` — authenticated encryption/decryption for server island props (via the shared `payloadCrypto.ts`, an SIV construction over AES-256-CTR).
